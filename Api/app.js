...
app.use((req, res, next) => {
  ...
  res.set("Content-Security-Policy", "font-src ''mongodb+srv://MariaLalin:JH6ZawffiMihNTPB@cluster0.2hcmmzt.mongodb.net/xancamposwebsite?retryWrites=true&w=majority''")
  next();
});
